...
parser.add_argument('--url', type=str, default='https://raw.githubusercontent.com/elymsyr/Stock-Price/main/Docs/Data/AAPL_stock_prices.csv', help='Url to csv data file')
